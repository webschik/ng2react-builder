// react-dom@16.3.1
const possibleStandardNames: {[key: string]: string} = {
    // HTML
    'accept': 'accept',
...
export function htmlAttr2React (name: string): string {
    return possibleStandardNames[name];
}

export function angularAttr2React (name: string): string {
    return possibleAngularNames[name];
}